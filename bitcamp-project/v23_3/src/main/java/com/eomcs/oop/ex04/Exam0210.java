...
public class Exam0210 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(s1.compareTo("Helli")); //해당 문자열과 비교하는 메서드
        System.out.println(s1.compareTo("Hello")); 
        System.out.println(s1.compareTo("Hellu"));
        
        System.out.println(s1.contains("ll"));  //특정 문자열에서 해당 문자열이 있는지 확인하는 메서드
        ...
        // => 형식을 갖춘 문자열을 만들기
        String s4 = String.format("%s님 반갑습니다", "홍길동");  //format 클래스 메서드

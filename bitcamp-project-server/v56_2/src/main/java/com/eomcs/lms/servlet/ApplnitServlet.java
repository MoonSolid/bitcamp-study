...
@WebServlet(value = "/ApplnitServlet", loadOnStartup = 1)
public class ApplnitServlet extends HttpServlet {
  private static final long serialVersionUID = 1L;

  static Logger logger = LogManager.getLogger(ApplnitServlet.class);
